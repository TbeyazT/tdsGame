...
local AnimateComponent = require(script.Parent.Parent.Parent.Parent:FindFirstChild('Components'):FindFirstChild('AnimationComponent'))
local Trove = require(game:GetService('ReplicatedStorage'):FindFirstChild('Packages'):FindFirstChild('Dumpster'))
local Net = require(game:GetService('ReplicatedStorage'):FindFirstChild('Shared'):FindFirstChild('Net'))
...
function UnitsClass:Init(frame)
	...
	self.Utils = require(script.Parent.Parent.Parent:FindFirstChild('BottomScreen'):FindFirstChild('Utils'))	
